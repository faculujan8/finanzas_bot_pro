...
{"tipo":"tarjeta","banco":"GALICIA","marca":"VISA","cuenta_pago":"GALICIA","total_extracto":184257.50,"filas":[{"fecha":"DD/MM/YYYY","monto":-5000,"tipo":"consulta_rubro","detalle":"Nombre del comercio exacto"},{"tipo":"consulta_rubro","detalle":"RADIO*SOMETHING*AR","monto":-3000,"fecha":"DD/MM/YYYY"}],"mensaje":"💳 Procesando..."}
- total_extracto: el "TOTAL CONSUMOS DEL MES" o "TOTAL A PAGAR" del extracto (número positivo)
...
4. Ignorá SOLO: SALDO ANTERIOR, SU PAGO, SALDO PENDIENTE, SUBTOTAL, TOTAL TITULAR, TOTAL A PAGAR, DEV PER RG (devoluciones)
